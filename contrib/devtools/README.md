...
101-Coin / 101CoinCore repository.
...
Setup
---------
Configuring the github-merge tool for the 101 Coin repository is done in the following way:

    git config githubmerge.repository 101-Coin/101CoinCore
...
A script to optimize png files in the 101 Coin
