...
*Setup instructions for a gitian build of 101 Coin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the 101 Coin
...
- [Building 101 Coin](#building-101coin)
...
Clone the git repositories for 101 Coin and gitian and then checkout the 101 Coin version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/101-Coin/101CoinCore
cd 101 Coin
...
Follow the instructions in [doc/release-process.md](release-process.md) in the 101 Coin repository
...
To build 101 Coin (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the 101 Coin repository.
...
```bash
    ...
    From https://github.com/101-Coin/101CoinCore
...
For example:
```bash
URL=https://github.com/101-Coin/101CoinCore
