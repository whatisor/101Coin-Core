101 Coin Core version 3.0.4 is now available from:
...
101 Coin Core v3.0.4 is a mandatory update for all users. This release contains various updates/fixes pertaining to the zPIV protocol, supply tracking, block transmission and relaying, as well as usability and quality-of-life updates to the GUI.
...
- #328 `a6c18c8` [Main] 101 Coin not responding on user quitting app (Aaron Langford)
