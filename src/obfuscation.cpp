    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat 101 Coin and make it unusable. To
...
bool CObfuscationPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymize101coinAmount * COIN - pwalletMain->GetAnonymizedBalance();
...
int CObfuscationPool::GetDenominations(const std::vector<CTxOut>& vout, bool fSingleRandomDenom)
{
    ...
    // Function returns as follows:
    //
    // bit 0 - 100 101+1 ( bit on if present )
    // bit 1 - 10 101+1
    // bit 2 - 1 101+1
    // bit 3 - .1  101+1
