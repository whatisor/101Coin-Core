Contributing to 101 Coin Core
============================

The 101 Coin Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the 101 Coin unit tests or QA tests
...
The following applies to code changes to the 101 Coin Core project, and is not to be
confused with overall 101 Coin Network Protocol consensus changes.

Whether a pull request is merged into 101 Coin Core rests with the project merge
...
Patches that change 101 Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the 101 Coin consensus, it must have been
...
The project leader is the release manager for each 101 Coin Core release.
